<?php
/**
 * Rider — full notifications list (role_notifications WHERE role='rider').
...
<div class="panel-page-header">
    <div>
        <h1>Notifications</h1>
        <p>Delivery alerts — new jobs, assignments and messages from the restaurant.</p>
    </div>
...
(function () {
    ...
    const ICON = { delivery: 'local_shipping', order: 'receipt_long', general: 'notifications' };
