<?php
/**
 * Chef — profile: view details, update name/avatar, change password.
 * Posts to the shared includes/panel_profile_update.php (works for any panel
 * role), which sets a flash message in $_SESSION['msg'] and redirects back.
 */
...
$name  = trim((string)($panelUser['name'] ?? '')) ?: 'Kitchen Chef';
...
$return = '/Merobhoj/chef/profile.php';
    ...
    <div class="panel-card">
        ...
        <div style="display:flex; align-items:center; gap:1rem; margin-bottom:1.2rem;">
            ...
            <div>
                ...
                <span class="note-scope" style="margin-top:0.3rem;">Kitchen Chef</span>
            </div>
        </div>
