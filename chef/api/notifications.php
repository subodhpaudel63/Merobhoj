<?php
/**
 * Role-scoped notifications for the chef panel (role_notifications WHERE role='chef').
...
// The chef panel always shows the 'chef' notification stream (admins viewing it too).
const NOTIFY_ROLE = 'chef';
